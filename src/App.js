    ...
    <Provider store={store}>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/member"
            element={tokenReady ? <MemberPages /> : <Navigate to={"/login"} />}
          ></Route>
          <Route
            path="/previewImages"
            element={tokenReady ? <PreviewImages /> : <Navigate to="/login" />}
          />
          <Route
            path="/cartView"
            element={tokenReady ? <CartView /> : <Navigate to={"/login"} />}
          ></Route>
          ...
          <Route
            path="/login"
            element={tokenReady ? <Navigate to={"/member"} /> : <Login />}
          ></Route>
          <Route
            path="/signup"
            element={tokenReady ? <Navigate to={"/member"} /> : <Signup />}
          ></Route>
        </Routes>
      </BrowserRouter>
    </Provider>
